...
const std::vector<std::vector<unsigned char>> AES_INVERSE_S_BOX =
{
...
const byte_buffer GALOIS_LUT_MUL_2 =
{
...
const byte_buffer GALOIS_LUT_MUL_3 =
{
...
const byte_buffer GALOIS_LUT_MUL_9 =
{
...
const byte_buffer GALOIS_LUT_MUL_11 =
{
...
const byte_buffer GALOIS_LUT_MUL_13 =
{
...
const byte_buffer GALOIS_LUT_MUL_14 =
{
...
byte_buffer AES::KeySchedule::GenerateKeys(byte_buffer key, AES_Mode_T aes_mode)
{
    ...
    for(size_t i=16; i<4*4*r; i+=4)
    {
        ...
        if( (i % (4*N)) == 0 )
        {
            current_word = CryptoMethods::XorBuffers(CryptoMethods::XorBuffers((last_key_oldest_word), SubWord(RotWord(previous_word), aes_mode)), rcon_word);
        }
        else
        {
